...
export const MyForm = ({ onSubmit, setDisplayName }) => {
  ...
  return (
       <Form>
      <Form.Group className="mb-3 mx-auto text-light" controlId="formBasicEmail">
        <Form.Label className="d-flex justify-content-center text-warning">Enter your name below for high score entry!</Form.Label>
        <Form.Control className="text-center text-warning bg-transparent" type="text" placeholder="Enter Your Name" />
